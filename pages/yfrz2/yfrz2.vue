<template>
	<view class="jf">
		<form>
			...
			<form-item label="成立时间" required>
				<picker mode="date" :value="form.clsj" @change="bindDateChange">
					<view class="uni-input">{{form.clsj}}</view>
				</picker>
			</form-item>
			<form-item label="公司规模" required>
				<select-input v-model="form.gsgm" :options="['支付宝', '微信','银行卡']"></select-input>
			</form-item>
