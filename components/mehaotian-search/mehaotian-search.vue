<template>
	<view class="search" :style="{ backgroundColor: backgroundColor }">
		<view :class="['content',(active && show && button === 'inside')&&'content-active']" :style="{ 'border-radius': radius + 'px',backgroundColor:bg}">
			<view class="content-box" :class="{ center: mode === 2 }">
				<text class="icon icon-search">&#xe61c;</text>
				<input class="input" placeholder-class="plac" :class="{ center: !active && mode === 2 }" :focus="isFocus" :placeholder="placeholder" v-model="inputVal" @focus="focus" @blur="blur" />
...
.content-active{
border: 2rpx solid #2EB79E !important;
}
@font-face {
